...
public class ListBluetooth extends AppCompatActivity {
    ...
    ListView IdLista;
    // String que se enviara a la Activity "Comunicación"
    ...
    public void onResume()
    {
        ...
        IdLista = (ListView) findViewById(R.id.listDeviceBT);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(ListBluetooth.this, Comunicacion.class);
